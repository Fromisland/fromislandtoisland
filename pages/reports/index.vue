    ...
    >
      ...
      <div class="flex flex-col w-full sm:w-[710px] gap-y-10 mt-12 sm:mt-0">
        <div class="flex flex-col border-b border-white/60 pb-10 items-center sm:items-start">
          <div class="flex flex-col sm:flex-row items-center sm:items-start gap-x-12">
            ...
            <div class="flex sm:hidden flex-col items-center h-full justify-center mt-5">
              ...
              <div
                class="font-noto text-[14px] text-white tracking-[2px] text-center leading-[30px]"
              >
          ...
          <div
            class="w-full sm:w-auto text-white font-noto text-[14.5px] tracking-[0.5px] text-justify leading-[30px] mt-8"
          >
        ...
        <div class="flex flex-col border-b border-white/60 pb-10 items-center sm:items-start">
          ...
          <div
            class="w-full sm:w-auto text-white font-noto text-[14.5px] tracking-[0.5px] text-justify leading-[30px] mt-8 sm:mt-16"
          >
        ...
        <div class="flex flex-col border-b border-white/60 pb-10 items-center sm:items-start">
          <div class="flex flex-col sm:flex-row items-center sm:items-start gap-x-12">
            ...
            <div class="hidden sm:flex flex-col h-full justify-center">
              <div class="font-noto font-semibold text-[20px] text-white tracking-[2px]">
                朱惠足<span class="text-[14px]">／國立中興大學台灣文學與跨國文化研究所教授</span>
              </div>
              <p class="font-noto text-white text-[13px] tracking-[2px] opacity-60 mt-2">
                台中日日新影城（2024.11.30）
              </p>
      ...
      <div class="flex flex-col mt-12 sm:mt-[150px] gap-y-8 w-full sm:w-auto">
        <div class="flex flex-col">
          ...
          <a
            ...
            class="font-noto text-[14px] sm text-[14px]:sm:text-[16px] leading-[36px] underline underline-offset-4 text-white/80 hover:text-white tracking-[2px]"
          >
        ...
        <div class="flex flex-col">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="font-noto text-[14px] sm:text-[16px] leading-[36px] underline underline-offset-4 text-white/80 hover:text-white tracking-[2px]"
          >
    ...
    >
      ...
      <div class="flex flex-col mt-[60px] gap-y-14 items-center sm:items-start w-full sm:w-auto">
        <div class="flex flex-col w-full sm:w-[710px] gap-y-7 border-b border-white pb-14">
          ...
          <p
            class="font-noto text-[14px] sm:text-[14.5px] text-white tracking-[0.5px] leading-[30px] text-justify"
          >
          ...
          <p
            class="font-noto text-[12px] sm:text-[14.5px] text-white tracking-[0.5px] leading-[30px] text-justify"
          >
